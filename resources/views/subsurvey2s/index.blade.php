...
<div class="container-fluid px-4">
    ...
    <div class="card mt-4 mb-4">
        <div class="card-header">
            <i class="fas fa-table me-1"></i> Daftar Subsurvey2
        </div>
            ...
            <table class="table table-bordered" id="datatablesSimple">
                <thead>
                    <tr>
                        ...
                        <th>Nama Subsurvey2</th> <!-- Relasi ke Subsurvey1 -->
                        <th>Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $subsurvey2->subsurvey1->nama_subsurvey }}</td>
                        <td>{{ $subsurvey2->nama_subsurvey2s }}</td> <!-- Menampilkan nama Subsurvey1 -->
                        <td>
